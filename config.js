...
window.APP_CONFIG = {
  ...
  // รหัสผ่านหน้าตรวจงาน admin.html — กันคนทั่วไปเปิดลิงก์เข้าถึงโดยไม่ตั้งใจเท่านั้น
  // (เช็คฝั่ง browser ล้วน ไม่ใช่ระบบความปลอดภัยจริงจัง คนที่ตั้งใจดูซอร์สโค้ดยังเห็นรหัสได้)
  ADMIN_PASSWORD: "kosin2569",
